...
開発のはっきりした出発点は，新着論文の Discord 通知に関する希望を聞いたことです[^1]．

[^1]: また，当時 ChatGPT 等による文献クロールでハルシネーションが生じたとも聞いたので，文献の収集はできるようにと考えました．
...
### 評価対象トピックが増えたらやったほうがよさそうなもの

* LLM 評価部分の改修（多く処理するために）
